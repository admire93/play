...
function other_asset_url($asset_name, $module_name = NULL, $asset_type = NULL)
{
	...
	$asset_location = $base_url.'public/';
...
function css_load($asset_name, $module_name = NULL, $attributes = array())
{
...
function img_tag($asset_name, $module_name = '', $attributes = array())
{
	$attribute_str = _parse_asset_html($attributes);
...
function js_load($asset_name, $module_name = NULL)
{
